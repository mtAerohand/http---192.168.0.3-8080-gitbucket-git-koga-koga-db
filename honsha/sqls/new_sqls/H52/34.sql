...
SELECT c.supplier_code ,COALESCE(d.supplier_name,'') AS supplier_name ,b.part_no ,b.engineering_change_no ,b.part_name ,c.process_code ,COALESCE(e.process_abbreviation,'') AS process_name ,a.requested_delivery_quantity ,a.partial_delivery_no ,b.incoming_order_no ,b.branch_no %s %s
